    ...
    <div className="bg-[#020617] text-white overflow-hidden">
      ...
      <section className="relative py-28 sm:py-36 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-8 lg:px-12">
          ...
          <p className="mt-8 text-gray-400 text-lg sm:text-xl leading-relaxed">
          ...
          {[
            {
              ...
              title: "Performance",
              desc: "Des solutions rapides, optimisées et scalables pour tous types de projets."
            },
            {
              icon: "bi-shield-check",
              title: "Sécurité",
              desc: "Nous développons des systèmes fiables avec les meilleures pratiques modernes."
            },
            {
              icon: "bi-stars",
              title: "Innovation",
              desc: "Toujours à la pointe des technologies pour offrir des expériences uniques."
            }
          ].map((item, i) => (
            <div
              key={i}
              className="text-center group relative overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] backdrop-blur-2xl p-8 hover:-translate-y-2 transition-all duration-500"
            >
      ...
      <section className="py-24 px-4 sm:px-8 lg:px-12">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-8 text-gray-400 text-lg leading-relaxed">
            AYACODIA est née d’une vision simple : rendre le digital accessible,
            moderne et puissant pour toutes les entreprises, des startups aux grandes structures.
            <br /><br />
            Nous combinons design, technologie et stratégie pour créer des produits digitaux
      ...
      <section className="py-20 px-4 sm:px-8 lg:px-12">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
          ...
          {[
            ...
            <div
              key={i}
              className="rounded-[28px] border border-white/10 bg-white/[0.04] backdrop-blur-2xl p-8 hover:-translate-y-2 transition"
            >
      ...
      <section className="py-24 px-4 sm:px-8 lg:px-12">
        ...
        <div className="max-w-5xl mx-auto text-center rounded-[40px] border border-white/10 bg-gradient-to-br from-indigo-600 to-blue-700 p-12 sm:p-16 shadow-[0_20px_80px_rgba(79,70,229,0.4)]">
